    ...
    for k in range(len(data)):
        ...
        for i in range(len(measurement)):
            ...
            for b in range(2):
                ...
                Xi.value[n+b][0] += -measurement[i][i+b] / measurement_noise
                Xi.value[m+b][0] +=  measurement[i][i+b] / measurement_noise
        ...
        for b in range(2):
            ...
            Omega.value[n+b][0] += -motion[b]/motion_noise
            Omega.value[n+b+2][0] +=  motion[b]/motion_noise
